export default {
  ...
  rate). Therefore, it controls the speed of the radiation; a greater delta
  will produce faster movement, lesser delta will generate slower movement.
  Note: the speed grows exponentially, so 1. a small change has a big impact
